...
<html>
	...
	<body>
		<div id="container">
			<h1>Gras</h1>
			<p><?= alternateBoldRegularWords("Essai juste avec des espaces."); ?></p>

			<p><?= alternateBoldRegularWords("Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium 
			...
			<p><?= alternateBoldRegularWords("On the other hand, we denounce with righteous indignation and dislike men who are 
				...
				through weakness of will, which is the same as saying through shrinking from toil and pain. These cases are perfectly 
				simple and easy to distinguish. In a free hour, when our power of choice is untrammelled and when nothing prevents our 
				being able to do what we like best, every pleasure is to be welcomed and every pain avoided. But in certain circumstances 
